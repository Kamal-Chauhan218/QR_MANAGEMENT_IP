  ...
  const validate = (event, name, value) => {
    ...
    switch (name) {
      ...
      case "FatherName": {
        if (!new RegExp(/^[a-zA-Z]+(?:(?:|['_. ])([a-zA-Z]*(\.\s)?[a-zA-Z])+)*$/).test(value)) {
          setErrors({
            ...errors, FatherName: "Enter a valid FatherName ",
          });
        } else {
      ...
      case "MotherName": {
        if (!new RegExp(/^[a-zA-Z]+(?:(?:|['_. ])([a-zA-Z]*(\.\s)?[a-zA-Z])+)*$/).test(value)) {
          setErrors({
            ...errors, MotherName: "Enter a valid MotherName ",
          });
        } else {
      ...
      case "FatherNumber": {
        if (!new RegExp(/^\s*(?:\+?(\d{1,3}))?[-. (]*(\d{3})[-. )]*(\d{3})[-. ]*(\d{4})(?: *x(\d+))?\s*$/).test(value)) {
          setErrors({
            ...errors, FatherNumber: "Enter a valid FatherNumber",
          });
        } else {
      ...
      case "MotherNumber": {
        if (!new RegExp(/^\s*(?:\+?(\d{1,3}))?[-. (]*(\d{3})[-. )]*(\d{3})[-. ]*(\d{4})(?: *x(\d+))?\s*$/).test(value)) {
          setErrors({
            ...errors, MotherNumber: "Enter a valid FatherNumber",
          });
        } else {
      ...
      case "SchoolNumber": {
        if (!new RegExp(/^\s*(?:\+?(\d{1,3}))?[-. (]*(\d{3})[-. )]*(\d{3})[-. ]*(\d{4})(?: *x(\d+))?\s*$/).test(value)) {
          setErrors({
            ...errors, SchoolNumber: "Enter a valid FatherNumber",
          });
        } else {
          ...
          <div>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                />
                <div>
                  {errors.FatherName && (<div className=" md:w-auto text-red-500">
                    {errors.FatherName}
                  </div>)}
                </div>
              </div>
              <div className="w-full md:w-1/2 px-3">
                ...
                />
                <div>
                  {errors.MotherName && (<div className=" md:w-auto text-red-500">
                    {errors.MotherName}
                  </div>)}
                </div>
              </div>
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                />
                <div>
                  {errors.FatherNumber && (<div className=" md:w-auto text-red-500">
                    {errors.FatherNumber}
                  </div>)}
                </div>
              </div>
              ...
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                />
                <div>
                  {errors.MotherNumber && (<div className=" md:w-auto text-red-500">
                    {errors.MotherNumber}
                  </div>)}
                </div>
              </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              ...
              <div className="w-full md:w-1/2 px-3">
                ...
                />
                <div>
                  {errors.SchoolNumber && (<div className=" md:w-auto text-red-500">
                    {errors.SchoolNumber}
                  </div>)}
                </div>
              </div>
